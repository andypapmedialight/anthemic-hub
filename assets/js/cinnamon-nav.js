(function () {
  ...
  var DEFAULT_KEYWORD_INTERESTS = [
    ...
    { keywords: ["brain", "map", "3d", "atlas", "creative", "macro", "atol", "genome"], interest: "creative" },
    { keywords: ["writing", "essay", "personal", "quill"], interest: "personal" },
    { keywords: ["hire", "mecca", "work", "job", "deck", "pitch", "atol", "genome", "pipeline"], interest: "work" },
  ...
  var DEFAULT_CONFIG = {
    ...
    intents: [
      ...
      { id: "projects", label: "Projects", scene: "projects", keywords: ["project", "setlist", "brain", "swarm", "tracker", "atol"], reply: "Anthemic projects. This way." },
