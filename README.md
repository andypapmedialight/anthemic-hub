...
- `assets/` — optional images / OG card / icons (served at `/assets/...`). The hub **Who am I** card expects **`assets/andy-cinnamon.jpg`** (photo of you and Cinnamon); until that file exists, the card shows a short placeholder.
